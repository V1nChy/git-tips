...
```sh
git init
git git remote add origin 远程仓库地址	#关联
git remote rm origin	#删除关联
git pull origin master	#拉取远程库内容到本地库
git pull origin master --allow-unrelated-histories	#允许不一样的历史)
git push origin master	#推送本地库内容到远程库
```
## 一图详解
